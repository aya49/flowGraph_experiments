shiny::htmlTemplate(
    ...
    # background visnet + absolute slider max nodes
    bg_visnet = shiny::div(
        class="outer",
        ...
        shiny::absolutePanel(
            id="slider_ap", class="panel panel-default",
            top=50, left=20, width=250, fixed=TRUE, draggable=TRUE, height="auto",
    ...
    dr_about = shiny::uiOutput("about_ui"),
