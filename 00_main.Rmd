...
## save files
fg = flowGraph(ftl, no_cores=no_cores, meta=meta_file, cls="class",
               label1="control", 
...
for (result_dir in result_dirs) {try({
    ...
    if (!grepl("pregnancy|bodenmiller", result_dir)) {
        fg = fg_summary(fg, no_cores=no_cores, cls="class", label1="control",
                        overwrite=FALSE, 
    ...
    for (feat in c(feat_orig, paste0("SpecEnr_",feat_orig))) {
        ...
        summary_meta0 <- c(feature=feat, test_name=test_name, 
                               class=tail(fg@summary_desc$node$class,1),
                               label1=tail(fg@summary_desc$node$label1,1),
                               label2=tail(fg@summary_desc$node$label2,1))
