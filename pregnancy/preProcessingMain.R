...
suppressWarnings(dir.create ("/mnt/f/FCS data/Immune_Clock_Human_Pregnancy/Results/"))
...
if(dataInfo == "Training"){
    ...
    outputPath <- "/mnt/f/FCS data/Immune_Clock_Human_Pregnancy/Results/FR-FCM-ZY3Q/"
        ...
        inputPath <- list(inPath)
        suppressWarnings(dir.create ("/mnt/f/FCS data/Immune_Clock_Human_Pregnancy/Results/FR-FCM-ZY3R/"))
