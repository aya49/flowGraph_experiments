## input: features 
## output: distance matrices; made with ogihara metrics for measuring distance between itemset databases
...
##   - c = length(intersect(x,y))/length(union(x,y)) -- lenght of itemset
